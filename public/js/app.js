...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_DataViewer_vue__ = __webpack_require__(30);
...
Component.options.__file = "C:\\Users\\sh.me\\Desktop\\dataviewer\\resources\\assets\\js\\components\\DataViewer.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-74cdf557", Component.options)
  } else {
    hotAPI.reload("data-v-74cdf557", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "change": function($event) {
        _vm.query.search_column = Array.prototype.filter.call($event.target.options, function(o) {
          return o.selected
        }).map(function(o) {
    ...
    on: {
      "change": function($event) {
        _vm.query.search_operator = Array.prototype.filter.call($event.target.options, function(o) {
          return o.selected
        }).map(function(o) {
          var val = "_value" in o ? o._value : o.value;
          return val
    ...
    domProps: {
      "value": _vm._s(_vm.query.search_input)
    },
    on: {
  ...
  }, [_c('span', [_vm._v("Displaying " + _vm._s(_vm.model.from) + " - " + _vm._s(_vm.model.to) + " of " + _vm._s(_vm.model.total))])]), _vm._v(" "), _c('div', {
    staticClass: "dv-footer-item"
  }, [_c('div', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-74cdf557", module.exports)
  }
}
